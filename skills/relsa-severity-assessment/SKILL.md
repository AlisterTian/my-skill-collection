...
description: "Combine animal-welfare readouts into RELSA severity scores and foRcast/ARIMA endpoint forecasts. Use for reference sets, normalization, thresholds, uncertainty, and research severity reporting."
license: MIT
