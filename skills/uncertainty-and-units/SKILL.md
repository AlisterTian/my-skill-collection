...
description: "Track units and propagate measurement uncertainty using pint, uncertainties, or Monte Carlo methods. Use for dimensional checks, GUM budgets, significant figures, and physical scale or regime plausibility."
license: MIT
