...
description: "Edit, translate, or compress existing academic prose while preserving evidence and terminology; also repair manuscript LaTeX layout. Use for language polishing, Results compression, or typesetting fixes; 论文润色、学术翻译、排版。"
---
