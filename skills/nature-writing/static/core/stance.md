...
- Preserve scientific meaning. Ask about missing evidence only when it blocks a supported claim; make routine framing choices from context and label assumptions. Continue supported drafting without inventing facts.
...
Use the supplied claim, evidence, and boundary wherever available. Mark missing facts explicitly and draft the supported portions. Consult workflow step 3b only when an unresolved premise would materially change the scientific claim; do not require confirmation of an entire outline for an ordinary draft request.
