...
10. **Choose output paths within the authorized workspace** for requested CSV/PNG files. Use a supplied path or a clearly named new output directory; ask only for an unresolved destination or an unintended overwrite.
