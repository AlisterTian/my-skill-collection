---
name: nature-data
description: "Draft or audit manuscript data/code availability statements, repository plans, dataset citations, and FAIR metadata. Use for research-data sharing and submission wording; 数据可用性声明。"
metadata:
