...
description: "Query GenSpectrum LAPIS and designation sources for current pathogen lineages, mutations, prevalence, growth, and assay-target matches. Use for time-sensitive genomic surveillance questions."
license: MIT
