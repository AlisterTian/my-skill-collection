...
description: "Find Nature, Science, Cell, and supported family-journal sources for manuscript claims, then export citation mappings and reference-manager files. Use when CNS/Nature source restrictions are requested; 补引用、分段引用。"
metadata:
