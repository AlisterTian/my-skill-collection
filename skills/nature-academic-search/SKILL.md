...
description: "Coordinate scholarly search, citation verification, reference-file conversion, and citation-impact audits via academic MCP tools. Use for multi-source retrieval, self/other-citation analysis, citer profiles, or citation tables. 文献检索、严格他引。"
---
