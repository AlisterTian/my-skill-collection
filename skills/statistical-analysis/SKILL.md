...
description: "Select and apply statistical methods to research data, check assumptions, estimate effects and uncertainty, and report results. Use for group comparisons, hypothesis tests, regression, or Bayesian analysis; use statistical-power for study sizing."
license: MIT license
metadata:
  version: "1.2"
