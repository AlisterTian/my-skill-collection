...
description: "Predict regulatory features, genes, or expression from DNA using the hosted Genomic Intelligence API or MCP. Use for its promoter, splice, enhancer, chromatin, expression, and gene-annotation workflows."
license: MIT
