---
name: waypoint-bio
description: "Use Outpost Bio Waypoint microbiome models, Atlas data, Compass benchmarks, and the waypoint CLI. Use for taxonomic-table conversion, embeddings, fine-tuning, pretraining, or checkpoint evaluation."
license: MIT
