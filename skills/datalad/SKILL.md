---
name: datalad
description: "Retrieve, version, publish, and reproduce scientific datasets with DataLad and git-annex. Use for DataLad datasets, annexed file pointers, storage siblings, and run/rerun provenance."
