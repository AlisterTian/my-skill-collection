...
description: "Discover and use scientific models, datasets, and Spaces from the Hugging Science catalog. Use for catalog selection or integration with Hugging Face APIs and libraries."
metadata:
  version: "1.3"
