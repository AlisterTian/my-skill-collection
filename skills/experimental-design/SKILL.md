...
description: "Plan experiments before data collection: choose designs, controls, randomization, blocking, replication, and treatment layouts. Use for study design or DOE; route sample-size calculations to statistical-power."
