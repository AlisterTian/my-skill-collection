...
description: "Calculate study sample sizes, power, minimum detectable effects, and power curves with formulas or simulation. Use for prospective study-sizing and power justification; distinguish from design selection and analysis of collected data."
