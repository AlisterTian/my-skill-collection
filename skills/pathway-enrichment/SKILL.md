...
description: "Analyze gene lists or ranked data with ORA, GSEA, or single-sample pathway scoring. Use for GO/KEGG/Reactome enrichment, background and gene-ID selection, multiple-testing correction, and enrichment interpretation."
license: MIT
metadata:
  version: "1.1"
