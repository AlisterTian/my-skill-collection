---
name: paper-lookup
description: "Retrieve scholarly records through public literature APIs: papers, identifiers, citations, open-access text, repository records, and journal OA status. Use for bounded lookups and searches with source provenance."
