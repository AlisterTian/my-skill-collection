...
description: "Convert and audit genomic coordinates, normalize variants, reconcile assemblies and contig names, or map genomic positions to transcripts and proteins. Use for BED/GFF/VCF convention, liftover, and REF-mismatch problems."
license: MIT
